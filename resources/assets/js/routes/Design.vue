<template>
    ...
    <div class="route">
        ...
        <div class="content-item">
            ...
            <p>Most recently I have been the <strong>lead designer</strong> for the interior design of the new $40 million Athletics Centre. This process includes creating hand draw wall wraps in Photoshop and using 3D animation software to fully visualize the branding and artistic designs of the building.</p>
        </div>
